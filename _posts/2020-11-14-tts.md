...
One more thing about the _loop strip mining_: **it doesn't work with every GC**. As far as I know it works only with **G1, Z and Shenandoah**. I did a test using a
**parallel GC** and on Java **11u6** this optimization doesn't work.
