---
layout: default
title:  "[Java][JVM][Profiling] From one JDK bug to another?"
date:   2020-12-14 09:51:30 +0100
---

# [Java][JVM][Profiling] From one JDK bug to another?
...
Our application stopped creating thread while invoking SOAP WebService. Yuppi. **I thought that the problem was solved, and then ...**
...
If we look at the stacktrace of the exception, we can ses method ```sun.security.ssl.SSLSocketImpl.shutdownInput```. Its source code:
```java
    @Override
...
## What about the original profiling application?
