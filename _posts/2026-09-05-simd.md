...
This example is not synthetic at all. Some time ago I had to speed up an algorithm whose first part had to count
...
generate all the **Vector API** code and to find proper CPU specs.