...
- spell checking,
- grammar fixes,
- rewriting parts (even chapters) of things I wrote,
- overall correctness of the article. 

All of this is done to compensate for my language gaps. I genuinely think that AI English is better than mine.
I don't use AI to make articles longer. I always assume that readers of this blog are not only low-level geeks, but
also high-level Java developers, who may not know low-level stuff. That's the reason for the verbosity
of my articles.

Since 2026, in the majority of my investigations I use AI as a tool to speed them up. If something useful is
generated by AI during such an analysis, I can also paste it into the article. For example, the table with the
`ASM -> pseudocode` translation from [this article](2026/08/19/g1barrier.html) was AI-generated. Since 2026.09
I will try to be more transparent about AI usage in each article, probably with a chapter at the end.
...
[**\[2026.09\]** JDK 26 and SIMD operations](2026/09/05/simd.html)
