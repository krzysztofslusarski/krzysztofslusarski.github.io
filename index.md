...
Here is my open source JVM and GC logs analyzer. Source code is available [here](https://github.com/krzysztofslusarski/jvm-gc-logs-analyzer). Web part
is deployed on [gclogs.com](http://gclogs.com/).
